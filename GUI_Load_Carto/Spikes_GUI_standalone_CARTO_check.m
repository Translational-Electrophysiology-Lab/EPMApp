function varargout = Spikes_GUI_standalone_CARTO_check(varargin)

%% Spikes_GUI_standalone_CARTO_check(signals(:,iis(1:20)),ParamSig.frequency,spikes,ParamSig.Label(iis(1:20)),do_wait);

% SPIKES_GUI_STANDALONE_CARTO_CHECK MATLAB code for Spikes_GUI_standalone_CARTO_check.fig
%      SPIKES_GUI_STANDALONE_CARTO_CHECK, by itself, creates a new SPIKES_GUI_STANDALONE_CARTO_CHECK or raises the existing
%      singleton*.
%
%      H = SPIKES_GUI_STANDALONE_CARTO_CHECK returns the handle to a new SPIKES_GUI_STANDALONE_CARTO_CHECK or the handle to
%      the existing singleton*.
%
%      SPIKES_GUI_STANDALONE_CARTO_CHECK('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SPIKES_GUI_STANDALONE_CARTO_CHECK.M with the given input arguments.
%
%      SPIKES_GUI_STANDALONE_CARTO_CHECK('Property','Value',...) creates a new SPIKES_GUI_STANDALONE_CARTO_CHECK or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Spikes_GUI_standalone_CARTO_check_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Spikes_GUI_standalone_CARTO_check_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Spikes_GUI_standalone_CARTO_check

% Last Modified by GUIDE v2.5 19-May-2019 16:14:57

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @Spikes_GUI_standalone_CARTO_check_OpeningFcn, ...
    'gui_OutputFcn',  @Spikes_GUI_standalone_CARTO_check_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before Spikes_GUI_standalone_CARTO_check is made visible.
function Spikes_GUI_standalone_CARTO_check_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Spikes_GUI_standalone_CARTO_check (see VARARGIN)

% Choose default command line output for Spikes_GUI_standalone_CARTO_check
...
% UIWAIT makes Spikes_GUI_standalone_CARTO_check wait for user response (see UIRESUME)
uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = Spikes_GUI_standalone_CARTO_check_OutputFcn(hObject, eventdata, handles)
...
% --------------------------------------------------------------------
function tag_zoom_in_OnCallback(hObject, eventdata, handles)
% hObject    handle to tag_zoom_in (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
pan off
datacursormode off
...
% --------------------------------------------------------------------
function tag_zoom_out_OnCallback(hObject, eventdata, handles)
% hObject    handle to tag_zoom_out (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
pan off
datacursormode off
